package org.example.crypto_javafx;
...
public class MainController {
    ...
    private void handleBrowse() {
        ...
        fileChooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Текстовый файл ", "*.encrypted"));
    ...
    private void handleProcess() {
        ...
        Processor processor = new Processor(filePath, key);
